...
Dependiendo del problema la base a usar, será distinta. Usaremos estas nuevas funciones y bases para generar una manera más flexible de representar $f(X)$. Los polinomios son una muy buena forma de aproximar cualquier funcion localmente, sin embargo tienden a comportarse de maneras erráticas de manera global. Ajustar una región de una función con un polinomio puede implicar que en valores grandes de nuestras entradas, el polinomio tome valores muy extremos. 
