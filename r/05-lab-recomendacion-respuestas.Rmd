...
## Ejercicio 3: Modelo de referencia regulariado (opcion 1)
...
## Ejercicio 3: Modelo de referencia regulariado (opcion 2)
...
########################################
### Lo "corro" pa todas las lambdas
lambdas <- c(0.01,0.1,1,10,100,1000)
recm <- sapply(lambdas, error.lam)

################################################################################
## lo grafico
plot(recm)
dat.graf <- tibble(lambda = lambdas, recm = recm)
ggplot(dat.graf, aes(x = lambda, y = recm)) + geom_point()

## No es muy claro! pruebo con mas lambdas y lambdas mas pequenas
lambdas <- c(0.001,0.01,0.1,1,5,10,20,40,60,80,100,200)
recm <- sapply(lambdas, error.lam)
plot(recm)
dat.graf <- tibble(lambda = lambdas, recm = recm)
ggplot(dat.graf, aes(x = lambda, y = recm)) + geom_point()
